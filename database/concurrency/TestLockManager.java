...
public class TestLockManager {
  ...
  @Test
  @Category(StudentTestP3.class)
  public void StudentInterestingOrder() throws InterruptedException {
        final LockManager lockMan = new LockManager();
    Thread thread1 = new Thread(new Runnable() {
      public void run() {
        /*Code to run goes inside here */
    ...
    Thread thread2 = new Thread(new Runnable() {
      public void run() {
        /*Code to run goes inside here */
        lockMan.acquireLock("B", 2, LockManager.LockType.SHARED);
      }
    }, "Transaction 1 Second Thread");
    ...
    thread1.start();
    thread1.join(100); //waits for thread to finish (timeout of .1 sec)
    assertFalse("Transaction 1 should have finished", thread1.isAlive()); //T1 should not be blocked
    assertTrue(lockMan.holdsLock("A", 1, LockManager.LockType.EXCLUSIVE)); //T1 should have shared lock

    thread2.start();
    thread2.join(100); //waits for thread to finish (timeout of .1 sec)
    assertFalse("Transaction 2 should have finished", thread2.isAlive()); //T1 Second thread should not be blocked
    assertTrue(lockMan.holdsLock("B", 2, LockManager.LockType.SHARED)); // T1 should still have shared lock

    thread3.start();
    thread3.join(100);
    assertFalse("Transaction 3 should  have finished", thread3.isAlive()); //T1 Second thread should not be blocked
    assertTrue(lockMan.holdsLock("B", 3, LockManager.LockType.SHARED));

    thread4.start();
    thread4.join(100);
    assertTrue("Transaction 2 Second Thread shouldn't have finished", thread4.isAlive()); //T1 Second thread should not be blocked
    assertFalse(lockMan.holdsLock("B", 2, LockManager.LockType.EXCLUSIVE));

    assertTrue(lockMan.holdsLock("A", 1, LockManager.LockType.EXCLUSIVE)); //T1 should now not have lock
    assertFalse(lockMan.holdsLock("B", 2, LockManager.LockType.EXCLUSIVE)); //T1 should now not have lock

    lockMan.releaseLock("B", 3);

    thread4.join(100); //wait for thread 2 to finish
    assertFalse("Transaction 2 Second Thread should have finished", thread4.isAlive()); //T2 should not be blo

    assertTrue(lockMan.holdsLock("B", 2, LockManager.LockType.EXCLUSIVE));
  }

  @Test
  @Category(StudentTestP3.class)
  public void StudentTestTwoSharedSameTransactionLockManager() throws InterruptedException {
    final LockManager lockMan = new LockManager();
    Thread thread1 = new Thread(new Runnable() {
      public void run() {
        /*Code to run goes inside here */
    ...
    thread3.start();
    thread3.join(100);
    assertTrue("Transaction 2 First Thread shouldn't have finished", thread3.isAlive()); //T1 Second thread should not be blocked
    assertFalse(lockMan.holdsLock("A", 2, LockManager.LockType.SHARED));
    ...
    thread3.join(100); //wait for thread 2 to finish
    assertFalse("Transaction 2 Thread should have finished", thread3.isAlive()); //T2 should not be block

    thread4.join(100); //wait for thread 2 to finish
    assertFalse("Transaction 2 Second Thread should have finished", thread4.isAlive()); //T2 should not be blo

    assertFalse(lockMan.holdsLock("A", 1, LockManager.LockType.EXCLUSIVE)); //T1 should now not have lock
    assertTrue(lockMan.holdsLock("A", 2, LockManager.LockType.EXCLUSIVE)); //T1 should now not have lock
  }


  @Test
  @Category(StudentTestP3.class)
  public void StudentTestManySharedTwo() throws InterruptedException {
    final LockManager lockMan = new LockManager();
    Thread thread1 = new Thread(new Runnable() {
      public void run() {
        /*Code to run goes inside here */
    ...
    thread2.start();
    thread2.join(100); //waits for thread to finish (timeout of .1 sec)
    assertFalse("Transaction 2 Thread should not have finished", thread2.isAlive()); //upgrade to Exclusive

    thread3.start();
    thread3.join(100); //waits for thread to finish (timeout of .1 sec)
    assertFalse("Transaction 3 Thread should not have finished", thread3.isAlive()); //T3 should be waiting on T1

    thread4.start();
    thread4.join(100); //waits for thread to finish (timeout of .1 sec)
    assertTrue("Transaction 4 Thread should not have finished", thread4.isAlive()); //T4 should be waiting on T1

    assertTrue(lockMan.holdsLock("A", 1, LockManager.LockType.SHARED)); //T1 has exclusive lock on A
    assertTrue(lockMan.holdsLock("A", 2, LockManager.LockType.SHARED));
    assertTrue(lockMan.holdsLock("A", 3, LockManager.LockType.SHARED));
    assertFalse(lockMan.holdsLock("A", 4, LockManager.LockType.EXCLUSIVE));
    ...
    thread4.join(100); //wait for thread 2 to finish
    assertTrue("Transaction 4 Thread should have finished", thread4.isAlive()); //T2 should not be blocked
  ...
  @Test
  @Category(StudentTestP3.class)
  public void StudentTestManyShared() throws InterruptedException {
    final LockManager lockMan = new LockManager();
    Thread thread1 = new Thread(new Runnable() {
      public void run() {
        /*Code to run goes inside here */
    ...
    lockMan.releaseLock("A", 3);

    thread4.join(100); //wait for thread 2 to finish
    assertFalse("Transaction 2 Thread should have finished", thread2.isAlive()); //T2 should not be blocked

    //T2,T3,T4 all promoted from queue and now have shared locks on A
    assertTrue(lockMan.holdsLock("A", 4, LockManager.LockType.EXCLUSIVE));
  }


  @Test
  @Category(StudentTestP3.class)
  public void StudentTestManySharedThree() throws InterruptedException {
    final LockManager lockMan = new LockManager();
    Thread thread1 = new Thread(new Runnable() {
      public void run() {
        /*Code to run goes inside here */
    ...
    lockMan.releaseLock("A", 1); //Transaction 1 releasing its lock
    thread4.join(100); //wait for thread 2 to finish
    assertFalse("Transaction 4 Thread should have finished", thread4.isAlive()); //T2 should not be blocked
    ...
    @Test
    @Category(StudentTestP3.class)
    public void testStudentTwoSharedSameTransactionLockManager() throws InterruptedException {
      final LockManager lockMan = new LockManager();
      Thread thread1 = new Thread(new Runnable() {
        public void run() {
        /*Code to run goes inside here */
