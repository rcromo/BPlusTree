...
public class TestDeadlockPrevention {
  ...
  public void testStudentThreeTransactionCycleDeadlock2() throws InterruptedException {
    final LockManager lockMan = new LockManager();
    AsyncDeadlockTesterThread thread1 = new AsyncDeadlockTesterThread(new Runnable() {
      public void run() {
    ...
    AsyncDeadlockTesterThread thread6 = new AsyncDeadlockTesterThread(new Runnable() {
      public void run() {
        lockMan.acquireLock("C", 2, LockManager.LockType.EXCLUSIVE);
      }
    }, "Transaction 2 Second Thread");
    ...
    try {
      ...
      thread2.join(100); //waits for thread to finish (timeout of .1 sec)
      thread2.test();
      assertFalse("Transaction 2 Thread should  have finished", thread2.isAlive()); //T2 should be waiting on T1 for A
      ...
      thread6.join(100); //waits for thread to finish (timeout of .1 sec)
      thread6.test();
      assertTrue("Transaction 2 Second Thread should not have finished", thread6.isAlive()); //T2 should not be blocked on C
    } catch (DeadlockException d) {
      fail("No deadlock exists but Deadlock Exception was thrown.");
    }
...
@Test
@Category(StudentTestP3.class)
public void StudentShareDeadLockExclusive() throws InterruptedException {
  final LockManager lockMan = new LockManager();
    AsyncDeadlockTesterThread thread1 = new AsyncDeadlockTesterThread(new Runnable() {
      public void run() {
        lockMan.acquireLock("A", 1, LockManager.LockType.SHARED);
  ...
  try {
      ...
      thread3.join(100); //waits for thread to finish (timeout of .1 sec)
      thread3.test();
      assertFalse("Transaction 2 Thread should  finished", thread3.isAlive()); //T3 should not be blocked
    ...
    try {
      ...
      thread4.join(100); //waits for thread to finish (timeout of .1 sec)
      thread4.test();
      assertFalse("Transaction 4  Thread should  finished", thread3.isAlive()); //T4 should not be blocked
...
@Test
@Category(StudentTestP3.class)
public void StudentSimpleSharedNoDeadLock() throws InterruptedException {
  final LockManager lockMan = new LockManager();
    AsyncDeadlockTesterThread thread1 = new AsyncDeadlockTesterThread(new Runnable() {
      public void run() {
        lockMan.acquireLock("A", 1, LockManager.LockType.SHARED);
    ...
    try {
      ...
      thread3.join(100); //waits for thread to finish (timeout of .1 sec)
      thread3.test();
      assertFalse("Transaction 2 Second Thread should  finished", thread3.isAlive()); //T2 should not be blocked
  ...
  @Test
  @Category(StudentTestP3.class)
  public void StudentPriorityDeadlock() throws InterruptedException {
    final LockManager lockMan = new LockManager();
    AsyncDeadlockTesterThread thread1 = new AsyncDeadlockTesterThread(new Runnable() {
      public void run() {
        lockMan.acquireLock("A", 1, LockManager.LockType.SHARED);
